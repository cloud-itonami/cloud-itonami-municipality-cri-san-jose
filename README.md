# cloud-itonami-municipality-cri-san-jose

Municipal-ordinance compliance catalog for **San José** (Cantón
Central, Costa Rica) — the NINETEENTH municipality-level entry
alongside
...
Both entries here instead cite
[pgrweb.go.cr](https://pgrweb.go.cr/scij/) (SCIJ, the national Sistema
Costarricense de Información Jurídica, which also indexes
municipal/cantonal regulations), which rendered fully: the
**Reglamento Autónomo de Organización y Servicio de la Municipalidad
de San José** (organizational regulation, enacted 1997-08-26) and the
**Reglamento de Publicidad Exterior** (exterior-advertising regulation,
...
itself remains the Municipality of San José's; this repo stores only
